<div class="container header-desktop">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
        <div class="left">
            <a href="/PTAW/index.php" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
        ...
        <div class="right">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item" id="mostrarCarrinho">
                    <a href="/PTAW/carrinho.php" class="nav-link" data-bs-toggle="offcanvas" data-bs-target="#carrinho" aria-controls="carrinho">
