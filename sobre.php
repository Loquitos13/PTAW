...
<body>
  ...
  <div id="meetTeam">
    <h2 style="text-align:center; margin-top:5vh; margin-bottom: 7vh; font-weight:700;">Meet Our Team</h2>
    <div class="containerTeam">
      <div class="boxTeam">
        <img src="imagens/filipe.jpg" alt="Filipe Rocha" class="imgProfile">
        <div class="boxText">
          <b class="nome">Filipe Rocha</b>
      ...
      <div class="boxTeam">
        <img src="imagens/rodrigo.jpg" alt="Rodrigo Oliveira" class="imgProfile">
        <div class="boxText">
          <b class="nome">Rodrigo Oliveira</b>
          <p class="role">CEO & Founder</p>
          <p class="role">Designer and Front-End Developer</p>
        </div>
        <div class="social">
          <a href="https://www.instagram.com">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="containerTeam">
      <div class="boxTeam">
        <img src="imagens/bruno.jpg" alt="Bruno Jardim" class="imgProfile">
        <div class="boxText">
          <b class="nome">Bruno Jardim</b>
          <p class="role">CEO & Founder</p>
      ...
      <div class="boxTeam">
        <img src="imagens/diogo.JPG" alt="Diogo Pinto" class="imgProfile">
        <div class="boxText">
          <b class="nome">Diogo Pinto</b>
          <p class="role">COO & Founder</p>
      ...
      <div class="boxTeam">
        <img src="imagens/guilerme.jpg" alt="Guilherme Ferreira" class="imgProfile">
        <div class="boxText">
          <b class="nome">Guilherme Ferreira</b>
          <p class="role">CEO & Founder</p>
          <p class="role">Back-End Developer</p>
        </div>
        <div class="social">
